...
export function InvitationMessage({ message }: { message: string }) {
  return (
    <section className="py-32 md:py-48 px-8 relative bg-bone text-center transition-colors duration-1000">
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        <p className="font-headline italic text-3xl md:text-4xl text-on-surface leading-relaxed tracking-wide font-light text-balance">
          {message}
        </p>
        <motion.div
          variants={{
