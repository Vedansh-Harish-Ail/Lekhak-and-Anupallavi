      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-surface flex items-end justify-center overflow-hidden pb-6 sm:pb-12"
          >
            ...
            {/* Content Canvas */}
            <div className="relative z-10 w-full flex flex-col items-center text-center pb-4 sm:pb-6">
              {/* Subtitle */}
              ...
              {/* Body Text */}
              <p className="font-body text-on-surface font-medium text-[11px] sm:text-xs leading-relaxed max-w-[280px] drop-shadow-sm mb-5 text-balance">
